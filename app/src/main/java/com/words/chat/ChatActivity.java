...
import com.words.chat.adapter.MessageAdapter;
...
public class ChatActivity extends Activity implements OnClickListener {
	...
	private void sendVoice(String filePath) {
		...
		DsdMessage message = DsdMessage.createVoiceMessage(DsdMessage.MESSAGE_TYPE_SEND_VOICE, filePath);
		adapter.msgList.add(message);

		DsdMessage message1 = DsdMessage.createVoiceMessage(DsdMessage.MESSAGE_TYPE_RECV_VOICE, filePath);
		adapter.msgList.add(message1);
